...
import verifyVehicle from '../services/verifyVehicle.service';
...
export default function VehicleVerification() {
    ...
    const handleVerifyVehicle = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        ...
        try {
            const response = await verifyVehicle(vehicle, vehicleNo, cookie);
        ...
        <>
            {
                ...
                <section className='w-screen h-screen flex justify-center items-center bg-gradient-to-b from-yellow-300 to-white'>
                    ...
                    <aside className='w-1/2 h-screen flex justify-center items-center'>
                        <form method='post' className='bg-white relative mx-auto h-fit mt-12 w-3/5 px-10 pt-4 pb-8 rounded-xl shadow-md shadow-gray-300' onSubmit={handleVerifyVehicle}>
                            <fieldset>
                                <div className='my-6'>
