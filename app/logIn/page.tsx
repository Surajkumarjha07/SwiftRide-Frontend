            ...
            <section className='w-screen h-screen flex justify-center items-center bg-gradient-to-b from-yellow-300 to-white'>
                <aside className="w-1/2 h-screen flex flex-col justify-center gap-6 px-20">
                    ...
                    <p className="text-xl text-gray-700 font-medium">
                        New to the platform?
                        <Link href="/signUp">
                            <span className="text-gray-950 font-bold underline"> Sign Up</span>
                        </Link>
                    </p>
                    ...
                    <form method='post' className='bg-white relative mx-auto h-fit mt-12 w-3/5 px-10 pt-4 pb-8 rounded-xl shadow-md shadow-gray-300' onSubmit={(e) => logIn(e)}>
                        <fieldset>
                            <div className='w-full relative'>
                                <button className={`${role === "user" ? "text-gray-950" : "text-gray-500"} rounded-t-md w-1/2 py-3 font-medium`} onClick={(e) => changeLogInType(e, "user")}>
                                    User
                                </button>

                                <button className={`${role === "captain" ? "text-gray-950" : "text-gray-500"} rounded-t-md w-1/2 py-3 font-medium`} onClick={(e) => changeLogInType(e, "captain")}>
                                    Captain
                                </button>
                            ...
                            <div className='my-6'>
                                <p className='text-center font-bold text-2xl text-gray-950'>Login to Account</p>
                            ...
                            <div className='text-left'>
                                ...
                                <div className='text-center mt-8'>
                                    <input type='submit' className={`w-full cursor-pointer ${submitClicked ? "bg-gray-900" : "bg-gray-950"} rounded-lg py-3 text-white font-semibold`} value={submitClicked ? "Signing In..." : "Sign In"} />
                                </div>
