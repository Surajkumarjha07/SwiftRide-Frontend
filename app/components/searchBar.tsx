...
export default function SearchBar() {
  return (
    <>
        <section className='bg-white flex items-center gap-4 absolute top-3 left-5 z-50 rounded-md px-4 py-2 drop-shadow-md drop-shadow-gray-400'>
            ...
            <button className='px-6 py-3 font-medium text-white bg-gray-950 rounded-md'>
                Find Ride
            </button>
        </section>
    </>
